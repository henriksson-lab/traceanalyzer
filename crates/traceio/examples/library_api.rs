...
//!
//! Usage:
//!   cargo run -p traceio --example library_api -- <input> [save-output]
...
fn main() -> anyhow::Result<()> {
    ...
    let detected = traceio::io::detect_format(&input)?
